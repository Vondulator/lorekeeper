                                ...
                                <tr class="character-reward-row">
                                    @if ($expanded_rewards)
                                        ...
                                        <td class="lootDivs">
                                            ...
                                            <div class="character-awards {{ $reward->rewardable_type == 'Award' ? 'show' : 'hide' }}">{!! Form::select('character_rewardable_id[' . $character->character_id . '][]', $characterAwards, $reward->rewardable_type == 'Award' ? $reward->rewardable_id : null, ['class' => 'form-control character-award-id', 'placeholder' => 'Select ' . ucfirst(__('awards.award'))]) !!}</div>
