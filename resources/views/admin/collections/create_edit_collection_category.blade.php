...
@section('admin-content')
    {!! breadcrumbs([
        'Admin Panel' => 'admin',
        'collection Categories' => 'admin/data/collections/collection-categories',
        ($category->id ? 'Edit' : 'Create') . ' Category' => $category->id ? 'admin/data/collections/collection-categories/edit/' . $category->id : 'admin/data/collections/collection-categories/create',
    ]) !!}
    ...
    @if ($category->id)
        ...
        <div class="card mb-3">
            <div class="card-body">
                @include('world._collection_category_entry', [
                    'item' => null,
