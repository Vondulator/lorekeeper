...
@section('admin-content')
    ...
    @if ($hunt->id)
        <h3>Display Link</h3>
        <p>For convenience, here is the hunt's url as well as the full HTML to display a link to the hunt's user-facing page. Hunt's pages inform users of how many of the hunt's targets they've found, and provide a recap of any clues attached to the
            found targets. Targets not yet found are not displayed, aside from indicating the total number; the full lineup can thus be indicated (or not) as desired.</p>
