    ...
    <div class="row">
        ...
        <div class="col-md">
            <div class="form-group">
                ...
                {!! Form::label('location_selection', 'Location Selection', ['class' => 'form-check-label ml-3']) !!} {!! add_help('Whether users may associate a gallery submission with a world location.') !!}
            </div>
        </div>
    </div>
