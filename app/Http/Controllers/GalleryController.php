    ...
    */
    ...
    public function getGallery($id, Request $request) {
        ...
        return view('galleries.gallery', [
            ...
            'locations'        => [0 => 'Any Location'] + Location::whereIn('id', GallerySubmission::where('gallery_id', $gallery->id)->visible(Auth::user() ?? null)->whereNotNull('location_id')->select('location_id')->distinct()->pluck('location_id')->toArray())->orderBy('name')->get()->pluck('styleParent', 'id')->toArray(),
