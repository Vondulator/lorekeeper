    ...
    */
    ...
    public function createSeason($data) {
        ...
        try {
            ...
            $season = WeatherSeason::create(Arr::except($data, ['weather_id', 'weight']));
    ...
    public function updateSeason($season, $data) {
        ...
        try {
            $data = $this->populateData($data, $season);
    ...
    public function createWeather($data) {
        ...
        try {
            ...
            $weather = Weather::create(Arr::only($data, ['name', 'description', 'parsed_description', 'is_visible', 'summary', 'has_image']));
    ...
    public function updateWeather($weather, $data) {
        ...
        try {
            $data = $this->populateWeatherData($data, $weather);
