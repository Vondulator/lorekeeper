    ...
    **********************************************************************************************/
    ...
    public function createPrompt($data, $user) {
        ...
        try {
            ...
            $prompt = Prompt::create(Arr::only($data, ['prompt_category_id', 'name', 'summary', 'description', 'parsed_description', 'is_active', 'start_at', 'end_at', 'hide_before_start', 'hide_after_end', 'prompt_timeframe', 'has_image', 'prefix', 'hide_submissions', 'staff_only', 'hash']));
    ...
    public function updatePrompt($prompt, $data, $user) {
        ...
        try {
            ...
            $prompt->update(Arr::only($data, ['prompt_category_id', 'name', 'summary', 'description', 'parsed_description', 'is_active', 'start_at', 'end_at', 'hide_before_start', 'hide_after_end', 'prompt_timeframe', 'has_image', 'prefix', 'hide_submissions', 'staff_only', 'hash']));
    ...
    private function populateData($data, $prompt = null) {
        if (($data['prompt_timeframe'] ?? null) === 'never') {
            $data['prompt_timeframe'] = null;
        }
        if (isset($data['description']) && $data['description']) {
            $data['parsed_description'] = parse($data['description']);
        }
